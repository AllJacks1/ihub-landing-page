...
export function MonthEventBadge({
  ...
  if (propPosition) {
    ...
    // Explicit multi-day row (day/agenda) — treat as standalone badge
    position = "none";
  ...
  const isMultiDay =
    eventCurrentDay != null && eventTotalDays != null && eventTotalDays > 1;

  // Only show a time on the first day of a multi-day span (or single-day)
  const showTime = renderBadgeText && (!isMultiDay || eventCurrentDay === 1);
