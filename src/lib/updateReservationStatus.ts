...
import { createSupabaseClient } from "./actions";
...
// Re-use the same email styles you already have
const emailStyles = {
  container:
...
export async function updateReservationStatus(
  ...
  // 1. Update the row and return the full reservation
  ...
  if (status === "confirmed" || status === "rejected") {
    ...
    try {
      ...
      const zone = zoneLabel(reservation.zone);
                  ...
                  <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="${emailStyles.card}">
                    ...
                    <tr>
                      <td style="${emailStyles.header}">
                        ...
                        <p style="margin:8px 0 0;color:rgba(255,255,255,0.85);font-size:15px;">
                          Hi ${reservation.full_name}, your booking is locked in.
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding:24px 40px 0;">
                        <span style="${emailStyles.badge}">Confirmed</span>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding:0 40px 32px;">
                        <h2 style="${emailStyles.sectionTitle}">What to Expect</h2>
                        <p style="margin:0 0 12px;color:#57534e;font-size:15px;line-height:1.6;">
                          Please arrive a few minutes early. If you need to make any changes or cancel, contact us as soon as possible.
                        </p>
